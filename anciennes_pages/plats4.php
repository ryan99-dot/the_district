...
<body>
    ...
    <div class="plat d-flex align-items-center justify-content-between">
        <img src="../assets/images/food/courgettes_farcies.jpg" alt="Courgettes farcies" id="courgettes"
    ...
    <div class="plat d-flex align-items-center justify-content-between">
        <img src="../assets/images/food/buffalo_chicken.webp" alt="Buffalo chicken" class="object-fit-cover" id="buffalo">
        <div class="tout d-flex">
            ...
            <div class="des_com flex-column align-items-center">
                <p class="description">Tortilla de blé, poulet façon wings, salade, carotte, avocat, fromage frais et tabasco</p>
                <a href="commande.php">
                    <button class="commander border-0 rounded-2 px-5">Commander</button>
                    <button class="commander_mobile border-0 rounded-circle px-2">+</button>
                </a>
    ...
    <div id="boutons" class="d-flex justify-content-around my-5">
        ...
        <button class="prec_desktop border-0 px-5 py-4 rounded-5">
            <a href="plats3.php" class="text-decoration-none text-dark">Précédent</a>
        </button>
        ...
        <button class="suiv_desktop border-0 px-5 py-4 rounded-5">
            <a href="plats5.php" class="text-decoration-none text-dark">Suivant</a>
        </button>
