<nav class="navbar navbar-expand-lg sticky-top d-flex justify-content-between p-0 shadow">
    ...
    <a href="commande.php"><img id="img_nav" src="../images/bg_rd.png"
            alt="Plusieurs plats sur fond bleu"></a>
    <div id="mySidenav" class="sidenav">
        <div class="d-flex justify-content-between align-items-center mx-5">
            <a href="commande.php"><i class="fa-solid fa-basket-shopping fs-1"></i></a>
            <a id="closeBtn" href="#" class="close">×</a>
        </div>
        <ul>
            <li><a href="index.php">Accueil</a></li>
            <li><a href="categorie.php">Catégories</a></li>
            <li><a href="plats1.php">Plats</a></li>
