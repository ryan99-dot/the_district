...
<body>
    ...
    <div class="plat d-flex align-items-center justify-content-between">
        ...
        <div class="tout d-flex">
            ...
            <div class="des_com flex-column align-items-center">
                <p class="description">2 steaks, 2 tranches de cheddar, salade, tomate, oignons cuits et mayonnaise</p>
                <a href="commande.php">
    ...
    <div class="plat d-flex align-items-center justify-content-between">
        ...
        <div class="tout d-flex">
            ...
            <div class="des_com flex-column align-items-center">
                <p class="description">Bun brioché, steak façon bouchère, salade, cornichon, oignons caramélisés et sauce burger</p>
                <a href="commande.php">
                    <button class="commander border-0 rounded-2 px-5">Commander</button>
                    <button class="commander_mobile border-0 rounded-circle px-2">+</button>
                </a>
    ...
    <div class="plat d-flex align-items-center justify-content-between">
        ...
        <div class="tout d-flex">
            ...
            <div class="des_com flex-column align-items-center">
                <p class="description">Bun brioché, steak façon bouchère, 2 tranches de cheddar, bacon et sauce BBQ</p>
                <a href="commande.php">
                    <button class="commander border-0 rounded-2 px-5">Commander</button>
                    <button class="commander_mobile border-0 rounded-circle px-2">+</button>
                </a>
    ...
    <div class="plat d-flex align-items-center justify-content-between">
        ...
        <div class="tout d-flex">
            ...
            <div class="des_com flex-column align-items-center">
                <p class="description">Bun brioché, steak, cheddar, salade, tomate et moutarde</p>
                <a href="commande.php">
                    <button class="commander border-0 rounded-2 px-5">Commander</button>
                    <button class="commander_mobile border-0 rounded-circle px-2">+</button>
                </a>
    ...
    <div id="boutons" class="d-flex justify-content-around my-5">
        ...
        <button class="prec_desktop border-0 px-5 py-4 rounded-5">
            <a href="plats5.php" class="text-decoration-none text-dark">Précédent</a>
        </button>
        <button class="prec_mobile border-0 bg-transparent">
            <a href="plats5.php" class="text-decoration-none text-dark">
                <i class="fa-solid fa-arrow-left"></i>
            </a>
        </button>
        <button class="suiv_desktop border-0 px-5 py-4 rounded-5">
            <a href="plats2.php" class="text-decoration-none text-dark">Suivant</a>
        </button>
