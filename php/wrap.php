...
<head>
    ...
    <link
        href="https://fonts.googleapis.com/css2?family=Farsan&family=Gwendolyn:wght@400;700&family=Julius+Sans+One&family=Modern+Antiqua&family=Nothing+You+Could+Do&display=swap"
        rel="stylesheet">
</head>
...
<body>
    ...
    <div class="plat d-flex align-items-center justify-content-between">
        <img src="../images/food/buffalo_chicken.webp" alt="Buffalo chicken" class="object-fit-cover">
